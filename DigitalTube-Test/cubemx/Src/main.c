...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  HAL_GPIO_WritePin(GPIOC, TM1629A_A_STB_Pin|TM1629A_A_CLK_Pin|LED_COMPETITION_Pin|LED_TRAIN_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(TM1629A_A_DIO_GPIO_Port, TM1629A_A_DIO_Pin, GPIO_PIN_RESET);
  ...
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(LED_ASSESS_GPIO_Port, &GPIO_InitStruct);

  /*Configure GPIO pins : BCD_3_Pin BCD_2_Pin BCD_1_Pin BCD_0_Pin */
  GPIO_InitStruct.Pin = BCD_3_Pin|BCD_2_Pin|BCD_1_Pin|BCD_0_Pin;
